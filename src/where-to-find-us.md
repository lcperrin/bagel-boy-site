  ...
  <div style="flex:1;min-width:260px;">
    ...
    <ul>
      <li>
        ...
        <a href="#" onclick="showMap('Buzz Coffee Old Port Portland Maine'); return false;" style="font-size: 0.8rem; margin-left: 0.5rem; color: var(--teal); font-weight: 700; text-decoration: underline;">(Click for Map)</a>
        <ul>
      ...
      <li>
        ...
        <a href="#" onclick="showMap('RattleShake South Portland Maine'); return false;" style="font-size: 0.8rem; margin-left: 0.5rem; color: var(--teal); font-weight: 700; text-decoration: underline;">(Click for Map)</a>
        <ul>
          <li>Sundays 10–1ish — At RattleShake, in South Portland.</li>
        </ul>
      </li>
      <li>
        <a href="https://www.google.com/maps/search/?api=1&query=Cia+Cafe+South+Portland+Maine" target="_blank" style="text-decoration:none; color:inherit;">
          <strong>Cia Cafe:</strong>
        </a>
        <a href="#" onclick="showMap('72 Ocean St STE 103, South Portland, ME'); return false;" style="font-size: 0.8rem; margin-left: 0.5rem; color: var(--teal); font-weight: 700; text-decoration: underline;">(Click for Map)</a>
        <ul>
          <li>delicious coffee, local food and art.</li>
        </ul>
      </li>
      <li>
